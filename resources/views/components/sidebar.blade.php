        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class=" py-2.7 text-sm ease-nav-brand cursor-pointer hover:bg-blue-500/20 rounded-lg my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                    ...
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Data Barang</span>
                </a>
            </li>
            ...
            @if (auth()->user()->role == 'company')
                <li class="mt-0.5 w-full">
                    <a class=" py-2.7 text-sm ease-nav-brand cursor-pointer hover:bg-blue-500/20 rounded-lg my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                        ...
                        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Data Distributor</span>
                    </a>
                </li>
                <li class="mt-0.5 w-full">
                    <a class=" py-2.7 text-sm ease-nav-brand cursor-pointer hover:bg-blue-500/20 rounded-lg my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"

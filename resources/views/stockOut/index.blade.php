            ...
            <div class="flex-none w-full max-w-full px-3">
                <div
                    ...
                    <div
                        ...
                        <h6 class="text-lg uppercase">Data Barang Keluar</h6>
                    ...
                    <div class="flex flex-wrap justify-between px-6 mt-6 gap-x-4 gap-y-8">
                        ...
                        <form action="{{ route('stock_out.index') }}" method="GET"
                                ...
                                <thead class="align-bottom">
                                    <tr>
                                        ...
                                        <th
                                            ...
                                            Jumlah Barang</th>
                                        <th
                                            class="px-6 py-3 text-xs font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70 price">
                                            Harga Satuan</th>
                                        <th
                                            class="px-6 py-3 text-xs font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70 total">
                                            Harga Total</th>
                                        <th
                                            class="px-6 py-3 text-xs font-bold text-left uppercase align-middle bg-transparent border-b border-collapse shadow-none border-b-solid tracking-none whitespace-nowrap text-slate-400 opacity-70">
                                            Petugas</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            const print = () => {
                ...
                table.prepend(
                    `<span class='px-6 my-8 text-lg font-bold'>Laporan Barang Keluar${end_date?" "+end_date:''} ${end_date?"s/d "+end_date:''}</span>`
                )
                // Remove the column with the 'action' class
                table.find('.action').remove();
                table.find('.price').remove();

                // Convert the table to PDF
                html2pdf()
                    .from(table[0])
                    .save(
                        `Laporan Barang Keluar${end_date?" "+end_date:''} ${end_date?"s/d "+end_date:''}.pdf`);
            }
        })
    </script>
@endsection
